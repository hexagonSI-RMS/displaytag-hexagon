 ...
 *
 *   1  May 2009 - We merged changes from the project SVN to address
 *     issue DISPL-409 - wrong sorting column in export
 *     issue DISPL-439 - include additional wild card features for excludedParams
 *
 *  29 July 2014 - Added support for "security" so table data will be "masked"
...
import org.displaytag.render.SecurityService;
...
public class TableTag extends HtmlTableTag
{
    ...
    public void addColumn(HeaderCell column)
    {
        ...
        if ((this.paginatedList != null) && (column.getSortable()))
        {
            ...
            {
            	this.tableModel.setDefaultTableSortProperty(sortProperty);
    ...
    private void initParameters() throws JspTagException, FactoryInstantiationException
    {
        ...
        {
        	if (this.paginatedList != null && this.paginatedList.getSortCriterion() != null)
        		this.tableModel.setPaginatedListSortProperty(this.paginatedList.getSortCriterion());
        ...
        else if (this.paginatedList == null)
        {
            ...
            if (tableModel.getDefaultTableSortColumnIndex() != null) // if there is a customized sort, use that
            	this.defaultSortedColumn = tableModel.getDefaultTableSortColumnIndex();
    ...
    protected void initHref(RequestHelper requestHelper)
    {
        ...
        if (this.excludedParams != null)
        {
            ...
            else
            {
                ...
                {
    	              // DISPL-439: Include additional wild card features for excludedParams.
                    // addedd by changg on 2009/5/1 #START
                    ...
                    else
                    {
    	              ...
    	              // addedd by changg on 2009/5/1 #END
                }
            }
        }
    ...
    public int doEndTag() throws JspException
    {
         ...
         * as the customization may have the default table sort column */
        ...
        RowIterator rowIterator = this.getTableModel().getRowIterator(true);
        SecurityService securityService = null;
        while (rowIterator.hasNext())
        {
        	Row row = rowIterator.next();
        	if (securityService == null) {
        		securityService = new SecurityService(row.getObject().getClass());
        	}
        	
        	if (securityService.classIsSecurable()
        			&& securityService.isRowSecured(row.getObject())) {
        		row.setSecured(true);
        	}
        }
    ...
    private String customizationLink_with_id = "<a data-recnum=\"%s\" data-table=\"%s\" class=\"gridcog\"><img src=\"%s/themes/default/images/icons/cog.png\"/>Customize Grid</a>";
    private String customizationLink_no_id = "<a class=\"gridcog\" data-table=\"%s\" ><img src=\"%s/themes/default/images/icons/cog.png\"/>Customize Grid</a>";
    ...
    public Long getSavedCustomizationPK() {
		CustomTableData customTableData = tableModel.getApplicationCustomTableData();
		return customTableData == null ? null : customTableData.getRecnum();
    }
