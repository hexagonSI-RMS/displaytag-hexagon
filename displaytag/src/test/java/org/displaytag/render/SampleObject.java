...
public class SampleObject {
	private String col1;
	private Boolean securedForUser;

	public SampleObject(boolean b, String string) {
		col1 = string;
		securedForUser = new Boolean(b);
    }
	...
	public Boolean getSecuredForUser() {
	    return securedForUser;
    }

	public void setSecuredForUser(Boolean securedForUser) {
	    this.securedForUser = securedForUser;
    }
}
